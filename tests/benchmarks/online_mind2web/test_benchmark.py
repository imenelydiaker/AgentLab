...
class TestOnlineMind2WebBenchmark:
    def test_model_post_init_loads_tasks(self):
        ...
        assert "1223b07536a87e0170ff87cbbebd1d3c" in [
            env_args.task_config.task_id for env_args in benchmark.env_args_list
        ]
    ...
    def test_model_post_init_filters_by_level(self):
        ...
        assert "99daaed9a83c266341d28aa40067d376" in [
            env_args.task_config.task_id for env_args in benchmark.env_args_list
        ]
